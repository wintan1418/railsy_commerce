...
ActiveRecord::Schema[8.0].define(version: 2026_04_13_190100) do
  ...
  create_table "ads", force: :cascade do |t|
    ...
    t.string "subtitle"
    t.string "link_url"
    t.string "placement", default: "home_mid", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["placement", "active", "position"], name: "index_ads_on_placement_and_active_and_position"
  end
  ...
  create_table "theme_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group"], name: "index_theme_settings_on_group"
    t.index ["key"], name: "index_theme_settings_on_key", unique: true
